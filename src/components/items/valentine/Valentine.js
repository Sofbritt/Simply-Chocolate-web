...
function Item() {
    return (
        <div>
            <div>
                <h2 className="title" >Valentine's Chocolates</h2>
            </div>
            ...
            <div className="all-natural">
                <h2 className="natural-title" >It's all natural</h2>
                <p className="natural-p" >At Simply, we use natural ingredients, and we go far beyond synthetic powder and artificial additives. You will therefore find no artificial sweeteners or preservatives in our chocolate. We are probably a bit picky when it comes to our ingredients. We only use the best that nature has available - taste and quality mean everything to us. Always. We spend a lot of time finding new and exciting flavors and we will go to great lengths for new innovative options, but we never compromise on good taste.
                </p> <br/>
              <a className="link" href="" >Read more about our love for natural chocolate</a>
            </div>
        </div>
    )
}
